...
module.exports = function compress(options) {
    ...
    if (options.client) {
        ...
        console.log('warnish-compress: redis client set as: %s:%s', options.client.port.host, options.client.port.port);
    }
    else {
    ...
    return function compress(req, res, next) {
        ...
        res.end = function (chunk, encoding) {
            ...
            if (stream && ignoreVerbs.indexOf(req.method) == -1) {
                ...
                console.log('warnish-compress: saving compressed response into redis. KEY: %s', cacheKey);
