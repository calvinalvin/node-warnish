/*
** Modified from https://github.com/jeffbski/redis-wstream
 */
...
function redisWStream(client, key, expires) {
    ...
    client.setex(key, expires, '', function (err, result) { // truncate any existing data
        if (err) return errored(err);
